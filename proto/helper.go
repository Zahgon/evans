...
func FullyQualifiedServiceName(pkg, svc string) string { _ = "STUB: not implemented"; return "" }

// FullyQualifiedMessageName returns the fully-qualified message name.
func FullyQualifiedMessageName(pkg, msg string) string { _ = "STUB: not implemented"; return "" }
